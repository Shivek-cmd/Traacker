...
const leftTestimonials = [
  ...
  },
  {
    ...
    stars: 5,
    quote:
      "They found me a consistent produce lane out of Florida that I've been running for four months. Before Traacker I had no idea lanes like that were available to a single truck.",
  },
]
...
const rightTestimonials = [
  ...
  },
  {
    ...
    stars: 5,
    quote:
      "I've used three dispatch services. Traacker is the first one that actually feels like they work for me instead of just collecting a check. The difference is night and day.",
  },
]
...
const featured = {
  ...
  stars: 5,
  quote:
    "I scaled from 3 trucks to 8 in under a year. Traacker handled dispatch for every single one. The lane strategy they put together cut my average deadhead from 22% down to 9%. That's not marketing — that's my actual numbers.",
}
